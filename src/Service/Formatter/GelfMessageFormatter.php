...
// Check if gelf-php v1.x (has setFacility method) or v2.x (doesn't have it)
if (method_exists('Gelf\Message', 'setFacility')) {
    // gelf-php v1.x - use default Monolog formatter
    ...
    // gelf-php v2.x - override to use setAdditional() instead of removed methods
    class GelfMessageFormatter extends MonologGelfMessageFormatter
    {
        use FormatterTrait;
        use NormalizeCompatibilityTrait;
         ...
         * {@inheritdoc}
         *
         * Override to support gelf-php ^2.0 which removed setFacility(), setLine(), and setFile() methods
         */
